...
function formatDate(date) {
    ...
    return `${hours}:${minutes} ${ampm}, ${day} ${weekday} ${month} ${year}`;
}
...
export {formatDate, formatBytes, stringSizeInBytes , deepArrayEqual, deepEqualObject, getInitials, capitalizeStringFirstLetter};